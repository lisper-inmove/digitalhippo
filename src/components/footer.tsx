    ...
    <footer className="bg-white flex-grow-0">
      <MaxWidthWrapper>
        <div className="border-t border-gray-200">
          ...
          {pathsToMinimize.includes(pathname) ? null : (
            <div className="relative flex items-center justify-center px-6 py-6 sm:py-8 lg:mt-0">
        ...
        <div className="py-10 flex md:items-center justify-center md:justify-between">
          <div className="text-center md:text-left">
            <p className="text-sm text-muted-foreground">
              &copy;{new Date().getFullYear()} All Rights Reserved
            </p>
          </div>
          <div className="mt-4 flex itmes-center justify-center md:mt-0">
